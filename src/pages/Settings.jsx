...
export default function Settings() {
  ...
  return (
    <div className="fade-up">
      ...
      <div className="card-flat" style={{ marginBottom: 18 }}>
        <div style={sectionTitle}>AI CEO behavior</div>
        <div style={row}>
          <div>
            <div style={rowLabel}>Proactivity</div>
            <div style={rowHint}>How aggressively the AI CEO surfaces suggestions. Wired in Milestone 3.</div>
          </div>
