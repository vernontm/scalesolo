...
const NODE_CATALOG = {
  ...
  script_gen: {
    ...
    description: 'Claude writes a script. Pick a format like tiktok-script, ig-post, thread, youtube-short, email-subject, blog-post.',
    inputs: ['topic'],
  ...
  caption_gen: {
    ...
    description: 'Generates a social caption + hashtags from a script.',
    inputs: ['script'],
  ...
  hashtag_gen: {
    ...
    description: 'Hashtag block from any input. props: count (number).',
    inputs: ['topic'],
    outputs: ['hashtags'],
  ...
  save_library: {
    ...
    description: 'Persist outputs as a content_scripts row. Connect any of: script, caption, hashtags, video.',
    inputs: ['script', 'caption', 'hashtags', 'video'],
    outputs: [],
